...
async fn test_profile_without_about_rejected() {
    ...
    assert!(result.is_empty(), "Profile without about should be rejected");
}
...
async fn test_profile_without_picture_rejected() {
    ...
    assert!(result.is_empty(), "Profile without picture should be rejected");
}
...
async fn test_placeholder_image_rejected() {
    ...
    assert!(result.is_empty(), "Profile with placeholder image should be rejected");
}
...
async fn test_relay_list_without_metadata_rejected() {
    ...
    assert!(result.is_empty(), "Relay list without existing metadata should be rejected");
}
...
fn test_profile_data_deserialization() {
    ...
    assert_eq!(profile.picture, Some("https://example.com/pic.jpg".to_string()));
}
